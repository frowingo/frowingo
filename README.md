...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Backend API foundation for the Houseflow project, focused on clean service structure and integration-ready endpoints.</p>
      <p>
        <img alt="Go" src="https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white" />
        <img alt="Backend" src="https://img.shields.io/badge/Backend-24292f?style=flat-square" />
        <img alt="API" src="https://img.shields.io/badge/API-0969da?style=flat-square" />
      </p>
    </td>
    <td width="50%">
      <h3><a href="https://github.com/frowingo/houseflowApp">houseflowApp</a></h3>
      <p>Swift iOS companion app for Houseflow, shaped around fast interaction and practical product flows.</p>
      <p>
        <img alt="Swift" src="https://img.shields.io/badge/Swift-F05138?style=flat-square&logo=swift&logoColor=white" />
        <img alt="iOS" src="https://img.shields.io/badge/iOS-000000?style=flat-square&logo=apple&logoColor=white" />
        <img alt="Product" src="https://img.shields.io/badge/Product-2da44e?style=flat-square" />
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <p>C#/.NET application experiment with an emphasis on structure, maintainability, and readable implementation.</p>
      <p>
        <img alt="C Sharp" src="https://img.shields.io/badge/C%23-512BD4?style=flat-square&logo=dotnet&logoColor=white" />
        <img alt=".NET" src="https://img.shields.io/badge/.NET-512BD4?style=flat-square" />
      </p>
    </td>
    <td width="50%">
      <h3><a href="https://github.com/frowingo/aniWidgets">aniWidgets</a></h3>
      <p>Swift widget-focused project exploring compact interfaces, app extensions, and glanceable UI patterns.</p>
      <p>
        <img alt="Swift" src="https://img.shields.io/badge/Swift-F05138?style=flat-square&logo=swift&logoColor=white" />
